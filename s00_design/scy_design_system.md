...
colors:
  ...
  # Texte
  text-primary: "#F3F4F6"      # Gris clair
...
| Niveau SMI        | Range  | Couleur      | Hex     | Signification        |
| ----------------- | ------ | ------------ | ------- | -------------------- |
| **Expert**        | 80-100 | Emerald      | #10B981 | Maîtrise complète    |
| **Maîtrisé**      | 65-79  | Bleu         | #3B82F6 | Compréhension solide |
| **Intermédiaire** | 40-64  | Jaune/Orange | #F59E0B | En progression       |
| **Débutant**      | <40    | Rouge        | #EF4444 | Nécessite travail    |
| **Pas de SMI**    | N/A    | Gris         | #9CA3AF | Pas encore évalué    |
