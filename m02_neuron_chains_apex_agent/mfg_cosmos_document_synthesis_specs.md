...
**Document ID** : PROPOSAL-MFG-DOCUMENT-SYNTHESIS-V1.0  
**Date** : 2026-06-12  
...
CREATE TABLE mfg_document_templates (
...
CREATE TABLE mfg_document_types (
    id                  UUID PRIMARY KEY DEFAULT gen_uuid_v7(),
    document_code       TEXT UNIQUE NOT NULL, -- 'S01', 'S03', 'G01'...
    document_name       TEXT NOT NULL,
    family_code         TEXT NOT NULL REFERENCES mfg_document_templates(family_code),
...
CREATE TABLE mfg_editorial_tones (
    id                  UUID PRIMARY KEY DEFAULT gen_uuid_v7(),
...
CREATE INDEX idx_document_types_code ON mfg_document_types(document_code);
CREATE INDEX idx_editorial_tones_code ON mfg_editorial_tones(tone_code);
```
